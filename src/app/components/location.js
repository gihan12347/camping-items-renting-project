...
export default function LocateUs({
  ...
  return (
    <div className="w-full bg-gradient-to-br from-green-50 via-green-100 to-orange-50 py-12 px-4">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-orange-400 rounded-full mb-2 shadow-lg">
            <MapPin className="w-8 h-8 text-white" />
          </div>
          <h2 className="text-5xl md:text-6xl font-bold text-gray-800 mb-2">Locate Us</h2>
        ...
        <div className="mt-8 text-center">
          <button
            ...
            className="group inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-green-400 to-orange-400 text-white font-bold text-lg rounded-full hover:from-green-500 hover:to-orange-500 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105"
          >
