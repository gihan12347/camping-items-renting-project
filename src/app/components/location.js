      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-4 text-white text-base md:text-lg max-w-2xl mx-auto px-4 drop-shadow-md">
            Ready for your next adventure? Contact us today and let's make your
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl p-6 md:p-8">
              ...
              <div className="space-y-4 text-gray-700 text-sm md:text-base leading-relaxed">
                <p>
                  ...
                  , your premier destination for quality camping gear rentals in
                  Sri Lanka. We believe that everyone should have the
                  opportunity to experience the beauty of nature without the
                  burden of expensive equipment purchases.
                </p>
                <p>
                  Our extensive collection includes premium tents, sleeping
                  bags, camping stoves, backpacks, and all the essential
                  equipment you need for an unforgettable outdoor adventure.
                  Whether you're planning a weekend getaway, a family camping
                  trip, or an extended wilderness expedition, we have everything
                  you need.
                </p>
                <p>
                  Nature Nest Camping helps travelers from the USA and Europe
                  enjoy unforgettable camping experiences in Sri Lanka. We
                  provide high-quality camping tents, sleeping bags, and outdoor
                  gear rentals for tourists, backpackers, and adventure seekers.
                </p>
                <p className="font-semibold text-orange-600">
                  Start your next adventure with us - because nature is calling,
                  and we have all the gear you need to answer!
                </p>
              </div>
            </div>
          </div>
