...
export default function TravelingObjects() {
  const [objects, setObjects] = useState([
    { id: 1, src: '/images/hicker-remove-bg.png', x: 150, y: 800, speed: 1.4, size: 60 },
    { id: 2, src: '/images/tent-remove-bg.png', x: 400, y: 900, speed: 1.2, size: 55 },
    { id: 3, src: '/images/lamp-remove-bg.png', x: 700, y: 850, speed: 1.8, size: 50 },
    { id: 4, src: '/images/gas-stove-remove-bg.png', x: 950, y: 950, speed: 1.1, size: 45 },
  ]);
